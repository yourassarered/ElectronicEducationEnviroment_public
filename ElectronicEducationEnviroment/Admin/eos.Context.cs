...
namespace ElectronicEducationEnviroment.Admin
{
    ...
    public partial class ElectronicEducationEnviromentEntities : DbContext
    {
        public ElectronicEducationEnviromentEntities()
            : base("name=ElectronicEducationEnviromentEntities")
        {
        }
        ...
        public virtual DbSet<LectureAccess> LectureAccesses { get; set; }
